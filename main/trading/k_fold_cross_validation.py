...
def main():
    ...
    kfold = cross_validation.KFold(
        len(snpret), n_folds=10, shuffle=True, random_state=42
    )

    # Use the kfold object to create index arrays
    # that state which elements have been retained for training
